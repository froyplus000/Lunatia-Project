...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Create Paths
        Path myroom2livingroom = new Path(new string[] { "north" }, "Living room", "Walking path to living room in North direction", myroom, livingroom);
        Path livingroom2myroom = new Path(new string[] { "south" }, "My room", "Walking path to my room in South direction", livingroom, myroom);

        Path myroom2kitchen = new Path(new string[] { "west" }, "Kitchen", "Walking path to kitchen room in West direction", myroom, kitchen, key);
        Path kitchen2myroom = new Path(new string[] { "east" }, "My room", "Walking path to my room in East direction", kitchen, myroom);
        ...
        Command commandProcessor = new CommandProcessor();
